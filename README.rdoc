...
The functional goal is to provide web page access to recipe information served
...
Feature:
By adding parametr looking_for=any_name at the end of the url, for instance https://search-coursera-name.herokuapp.com/?looking_for=diet, the data will be apdated and courses relevent to the paramtr will apper.
